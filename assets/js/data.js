...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: '친구 있지! 절대 이성으로만 안 보일뿐', type: [0, 3, 6, 6, 1, 8] },
      { answer: '난 잘 모르겠어:)', type: [7, 1 ] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: '언제 연락할지, 어떻게 말할지 심사숙고하여 연락한다.', type: [1, 6, 6, 1] },
      { answer: '상대방에게 먼저 연락 올 때까지 기다린다.', type: [7, 4, 9, 1] },
    ]
  },
  {
    q: '3. 당신의 고백 스타일은? >"<',
    a: [
      { answer: '호감이 보이면 바로 고백한다', type: [1, 3, 2, 1, 8] },
      { answer: '상대방이 고백할 때까지 기다린다', type: [7, 9, 1] },
      { answer: '완벽한 분위기, 완벽한 타이밍에서 고백한다.', type: [0, 6, 6, 4] }
    ]
  },
  {
    ...
    a: [
      ...
      { answer: '섬세한 "나 너 많이 좋아해, 나랑 사귈래?" ', type: [7, 1, 8, 9, 1 ] },
  ...
  },
  {
    ...
    a: [
      { answer: '쑥스러워.. 손 잡기 정도??', type: [1, 7, 1, 4, 9 ] },
      { answer: '요즘 시대가 어느 때인데, 가벼운 뽀뽀까지 가능이야', type: [0, 3, 6, 1]},
...

  {
    ...
    a: [
      { answer: '무슨 기념일이야, 그냥 평소처럼 해', type: [4, 9, 1 ] },
      { answer: '맛있는 밥이나 사줄까? 아니면 꽃이라도?', type: [0, 3, 6, 1 ] },
  ...
  },
  {
    ...
    a: [
      { answer: '눈치 못 채고 그냥 있는다', type: [1, 7, 1 ] },
      { answer: '눈치는 채나 말은 꺼내지 않는다', type: [2, 4, 9 ] },
      { answer: '"오 대박 오늘 머리도 바꾸고 옷도 새로 샀네?"라고 하며 단번에 눈치챈다', type: [0, 3, 6, 6, 1, 8 ] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: '연인이 살고 있는 집의 역이나 정류장까지 데려다준다.', type: [3, 2, 6, 6, 1, 8 ] },
      { answer: '집 앞까지 데려다준다.', type: [1, 7, 1 ] },
    ]
  },
  {
    q: '9. 연인에게 하루종일 연락이 안 온다..^_^',
    a: [
      { answer: '뭐.. 언젠가 연락 오겠지. 내가 할 일 하며 기다린다', type: [7, 0, 6, 9 ] },
      { answer: '초조해서 마음 졸이며 인스타, 페북, 카톡 등 모든 SNS 다 들어가본다.', type: [1, 3, 6, 1 ] },
      { answer: '연인에게 연락 올 때까지 무한 카톡, 무한 전화', type: [2, 1, 8, 4 ] },
    ]
  },
  {
    q: '10. 연인이 연락도 없이 보고싶다고 우리집 앞에 와서 기다린다. >_<',
    a: [
      { answer: '아니 갑자기 오면 어떡해.. 하 나 준비도 안 했는데 왜 와. 짜증나네', type: [4, 9, 1] },
      { answer: '아 그래?? 나 할 것들 좀만 마무리하고 나갈게', type: [0, 2, 6, 6 ] },
      { answer: '헐 대박, 어디야?? 당장 나갈게!', type: [1, 7, 3, 1, 8 ] },
    ]
  },
  {
    q: '11. 내가 추구하는 연애관은? =]',
    a: [
      { answer: '각자 할 것 하며, 평안하고 안정적인 연애가 좋다.', type: [1, 4, 9, 1 ] },
      { answer: '보고싶을 때 보고, 데이트도 많이 하고 꽁냥꽁냥하는 연애가 좋아.', type: [7, 0, 3, 6, 1] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '"야! 너 화내지마. 너 잘못이지. 내가 뭘 잘못했는데?" 소리지르며 끝까지 불같이 화낸다.', type: [0, 2, 6, 1, 8] },
      { answer: '"아니 그건 아니고, 하.." 조용히 운다.', type: [1, 7, 1] },
    ]
  }
]
