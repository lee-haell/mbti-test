const qnaList = [
  {
    ...
    a: [
      { answer: '1️⃣ 이성 사이에 친구가 어딨어? 절대 없어', type: ['cow', 'tiger', 'dragon', 'chick'] },
      { answer: '2️⃣ 친구 있지! 절대 이성으로만 안 보일뿐', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
      { answer: '3️⃣ 난 잘 모르겠어:)', type: ['sheep', 'pig' ] },
    ]
  },
  {
