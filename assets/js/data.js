...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: '친구 있지! 절대 이성으로만 안 보일뿐.', type: [0, 3, 6, 6, 10, 8] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '"오 대박 오늘 머리도 바꾸고 옷도 새로 샀네?"라고 하며 단번에 눈치챈다.', type: [0, 3, 6, 6, 10, 8 ] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: '연인이 살고 있는 집의 역이나 정류장까지 데려다준다.', type: [3, 2, 6, 6, 10, 8 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '"야! 너 화내지마. 너 잘못이지. 내가 뭘 잘못했는데?" 소리지르며 끝까지 불같이 화낸다.', type: [0, 2, 6, 10, 8] },
