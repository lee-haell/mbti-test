const qnaList = [
  ...
  {
    q: '오늘 연인과 첫 데이트 하는 날이다. 첫 날 허용할 수 있는 스킨십의 범위는? X_X',
    a: [
  ...
  {
    q: '기념일이 다가온다. 당신은 어떻게 할 것인가? (ex - 100, 200일) O_O',
    a: [
  ...
  {
    q: '연인이 데이트가 끝난 후, 집에 데려다 달라고 한다. :D',
    a: [
  ...
  {
    q: '연인이 연락도 없이 보고싶다고 우리집 앞에 와서 기다린다. >_<',
    a: [
