...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: '친구 있지! 절대 이성으로만 안 보일 뿐.', type: [0, 3, 6, 5, 10, 8] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '완벽한 분위기, 완벽한 타이밍에 고백한다.', type: [0, 6, 5, 4] }
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '"오, 대박! 오늘 머리도 바꾸고 옷도 새로 샀네?" 단번에 눈치챈다.', type: [0, 3, 6, 5, 10, 8] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: '연인이 살고 있는 집 근처 역이나 정류장까지 데려다준다.', type: [3, 2, 6, 5, 10, 8] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '그래? 하던 일 마무리하고 나갈게~', type: [0, 2, 6, 5] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '"야! 화내지마. 내가 뭘 잘못했는데?" 소리지르며 불같이 화낸다.', type: [0, 2, 5, 10, 8] },
