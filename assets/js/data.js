...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: '친구 있지! 절대 이성으로만 안 보일 뿐.', type: [0, 3, 6, 6, 10, 8] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '언제 연락할지, 어떻게 말할지 심사숙고하여 연락한다.', type: [1, 6, 6, 10] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '완벽한 분위기, 완벽한 타이밍에 고백한다.', type: [0, 6, 6, 4] }
    ]
  },
  {
    ...
    a: [
      ...
      { answer: '센스있는, "우리 내일은 연인으로 만날까요?"', type: [0, 3, 6, 6] },
    ]
  },
  {
    q: '5. 첫 데이트 날 가능한 스킨십의 범위는?',
    a: [
      { answer: '쑥스러워... 손 잡기 정도?', type: [1, 7, 10, 4, 9] },
      { answer: '요즘 시대가 어느 때인데, 가벼운 뽀뽀까지 가능이야.', type: [0, 3, 6, 11]},
      { answer: '어차피 내 연인인데 왜? 모든 스킨십 다 돼!', type: [2, 6, 8] },
    ]
  },

  {
    q: '6. 기념일에 당신은 어떻게 할 것인가?',
    a: [
      { answer: '무슨 기념일이야, 그냥 평소처럼 해.', type: [4, 9, 11] },
      { answer: '맛있는 밥이나 사줄까? 아니면 꽃이라도?', type: [0, 3, 6, 10] },
      { answer: '이미 깜짝 이벤트 다 준비해놨어!', type: [1, 7, 2, 6, 8] },
    ]
  },
  {
    q: '7. 연인이 스타일을 바꾸고 왔다면?',
    a: [
      { answer: '눈치 못 채고 그냥 있는다.', type: [1, 7, 11] },
      { answer: '눈치는 채나 말은 꺼내지 않는다.', type: [2, 4, 9] },
      { answer: '"오, 대박! 오늘 머리도 바꾸고 옷도 새로 샀네?" 단번에 눈치챈다.', type: [0, 3, 6, 6, 10, 8] },
    ]
  },
  {
    q: '8. 연인이 집에 데려다 달라고 한다면?',
    a: [
      { answer: '각자 만났던 장소에서 헤어진다.', type: [0, 4, 9] },
      { answer: '연인이 살고 있는 집 근처 역이나 정류장까지 데려다준다.', type: [3, 2, 6, 6, 10, 8] },
  ...
  },
  {
    ...
    a: [
      { answer: '뭐... 언젠가 연락 오겠지. 내 할 일 하며 기다린다.', type: [7, 0, 6, 9] },
      { answer: '초조해서 마음 졸이며 모든 SNS 다 들어가본다.', type: [1, 3, 6, 11] },
      { answer: '연인에게 연락 올 때까지 무한 카톡, 무한 전화~', type: [2, 10, 8, 4] },
    ]
  },
  {
    q: '10. 연인이 갑자기 집 앞에서 기다린다면?',
    a: [
      { answer: '아니 갑자기 오면 어떡해... 나 준비도 안 했는데 짜증나네?', type: [4, 9, 11] },
      { answer: '그래? 하던 일 마무리하고 나갈게~', type: [0, 2, 6, 6] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '연애는 마음가는대로! 불타오르는 연애가 최고지!', type: [2, 6, 8] },
    ]
  },
  {
    q: '12. 연인과 데이트 도중 심하게 싸웠다면?',
    a: [
      { answer: '"화나네, 따라오지마. 오늘 집 갈 거니까." 라고 말하며 집으로 간다.', type: [3, 6, 4, 9] },
      { answer: '"야! 화내지마. 내가 뭘 잘못했는데?" 소리지르며 불같이 화낸다.', type: [0, 2, 6, 10, 8] },
      { answer: '"아니 그건 아니고... 하ㅜㅜ" 조용히 운다.', type: [1, 7, 11] },
    ]
  }
]
...
const infoList = [
  ...
  },
  {
    ...
    desc: '연애 유형이 진국인 당신! 소에 해당하는 당신은 상대방만 바라보는 해바라기 연애 스타일이랍니다. 매사에 끈기가 있어 연애를 할 때 성실하고 진심을 다하는 성향을 가지고, 온화하며 따뜻한 마음을 가지고 있어요. 한 번 좋아하면 끝까지 좋아하는 의리파지만 자존심이 쌔 은근히 고집이 강하답니다. 또한 욱하는 성질이 있어 이런 부분들을 조심해야 하고, 질투심이 많아 사랑이 집착으로 바뀔 수 있어 주의해야 된답니다!'
  },
  {
  ...
  },
  {
    ...
    desc: '상대방과의 미래를 꿈꾸는 당신! 현실적인 연애보다는, 미래에 대한 이상적인 연애관을 가지고 있어요. 매일매일 사랑하는 사람과 보낼 미래를 생각하기 때문에, 좋은 배우자가 될 수 있는 자질이 있답니다. 또한 일적으로나 사랑으로나 야망이 커, 크게 성공할 확률이 높고 리더십이 매우 뛰어납니다. 다만 높은 이상에 비해서 현실이 자신의 마음에 들지 않으면 허세를 부리거나 사람들을 무시하는 경우가 많으니 이점들을 주의하면 좋을 것 같아요!'
  },
  {
  ...
  {
    name: '오늘 머리 바꿨네? 잘 어울린다! 센스가 뛰어난 <말>',
    desc: '연애할 때, 센스가 넘쳐나는 당신! 말재주가 뛰어나며 처세술이 뛰어나, 상대방의 호감을 금방 얻는답니다. 낙천적이고 유연한 성격을 가지고 있으며, 구속받는 것을 싫어하는 스타일이에요. 소중한 사람들을 위해 희생할 줄도 알지만, 쾌락 지향적인 경우가 많아 사치와 허영에 물드는 경우가 다반수입니다. 한탕 주의에 빠져 쉽게 망가질 수 있기 때문에 이 점을 주의해야 된답니다!'
  },
  {
